...
#       and how to create simple variables. If you are unsure, you need to find
#       how to do it yourself or use Stata where some hints are given. This file
#       only gives you the command to open the dataset.
